-- Step 1. Retrieve customer id and name when the user is active.
...
savings_monthly AS (
    ...
    WHERE s.confirmed_amount > 0  -- Ensure it is a real inflow
...
withdrawals_monthly AS (
    ...
    WHERE w.amount_withdrawn > 0  -- Ensure it is a real outflow
